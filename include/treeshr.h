...
#include <mdsdescrip.h>
  ...
  extern EXPORT int TreeCloseEx(char const *tree, long shot);
  extern EXPORT int _TreeClose(void **dbid, char const *tree, int shot);
  extern EXPORT int _TreeCloseEx(void **dbid, char const *tree, long shot);
  ...
  extern EXPORT int TreeOpenEx(char const *tree, long shot, int flags);
  extern EXPORT int _TreeOpen(void **dbid, char const *tree, int shot, int flags);
  extern EXPORT int _TreeOpenEx(void **dbid, char const *tree, long shot, int flags);
  extern EXPORT int TreeOpenEdit(char const *tree, int shot);
  extern EXPORT int TreeOpenEditEx(char const *tree, long shot);
  extern EXPORT int _TreeOpenEdit(void **dbid, char const *tree, int shot);
  extern EXPORT int _TreeOpenEditEx(void **dbid, char const *tree, long shot);
  extern EXPORT int TreeOpenNew(char const *tree, int shot);
  extern EXPORT int TreeOpenNewEx(char const *tree, long shot);
  extern EXPORT int _TreeOpenNew(void **dbid, char const *tree, int shot);
  extern EXPORT int _TreeOpenNewEx(void **dbid, char const *tree, long shot);
...
//Segments
  ...
  extern EXPORT int TreeSetCurrentShotIdEx(char const *experiment, long shot);
  extern EXPORT int TreeGetCurrentShotId(char const *experiment);
  extern EXPORT long TreeGetCurrentShotIdEx(char const *experiment);
